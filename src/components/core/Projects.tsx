...
//     <div className="w-full h-full rounded-3xl p-6 gap-4 xl:gap-10 flex flex-col justify-between  bg-gradient-to-r from-slate-900 to-slate-800">
//       <div className="flex flex-col cursor-default">
//       <p className='mb-3 text-base font-semibold font-edu-sa'>Projects</p>
//         <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 '>
//         {PROJECT_DETAIL.map((item,key)=>(
//             <div key={item.id} className='[perspective:1000px] group'>
//               <div className='relative flex flex-col min-h-28 bg-slate-900 gap-0.5 shadow-[0_1px_4px_rgba(8,_112,_184,_0.7)] hover:shadow-[0_1px_10px_rgba(8,_112,_184,_0.7)] hover:scale-[98%] p-1 px-2 mb-1 rounded-lg  [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] transition-all duration-500'>
//               <div className='flex flex-col justify-between p-1 h-full [backface-visibility:hidden]'>
//                   <div className='text-[14px] text-[#ece8e8]  font-semibold font-edu-sa'>{item.name}</div>
//                   <div></div>
//                   <div className='text-xs text-[#716f6f]  font-semibold'>TechStacks</div>
//                   <div className='flex justify-between items-center'>
