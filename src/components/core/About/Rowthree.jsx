  ...
  return (
    <div>
      <div className='text-white grid grid-cols-2 xl:grid-cols-4 gap-5 xl:h-[250px]'>
        ...
        <div className='col-span-2 relative row-start-1 xl:row-start-1 w-full h-full group flex flex-col text-3xl sm:text-5xl font-semibold rounded-[10px] sm:rounded-[30px] blackwhite p-2 md:p-10 ' data-aos="fade-in">
            <Letsconnect/>          
        </div>
