...
const Rowone = () => {
  ...
  return (
    <div className='text-white pt-11 px-2 grid grid-cols-1 xl:grid-cols-2 gap-5'>
            <div className='w-full h-full group flex justify-between xl:justify-normal gap-4 xl:gap-14 items-center px-2 py-7 md:px-10 rounded-[10px] sm:rounded-[30px] blackwhite shadow-xl border border-black hover:border-[#363636] transition-all duration-500 shadow-custom1' data-aos="fade-in">
